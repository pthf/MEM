...
<div class="menuNav" ng-controller="menuNavController">
	<div class="row">
      ...
      <ul class="nav nav-pills nav-stacked">
  			<li style="background: #23275f; color: #FFF;" role="presentation" ng-class="{active:selected===1}" ng-click="changeNav(1)"><a href="#/projects" style="color: #FFF;"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>Projects</a></li>
