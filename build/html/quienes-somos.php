...
<html>
  <head>
    ...
    <title>Medicina Empresarial en Movimiento - Quienes Somos</title>
  ...
  <header>
    ...
    <section class="menu-bar">
      <ul class="list-content">
        ...
        <a href="quienes-somos.php"><li class="list-item selected-menu-item"><span class="selected-menu-opt">Quiénes somos</span></li></a>
    ...
    <span class="nav-icon" >&#9776;</span>
      <ul class="mobile-nav animated">
        ...
        <a href="quienes-somos.php"><li class="list-item selected"><span>Quiénes somos</span></li></a>
  ...
  <div class="sites-quien">
    <h2 class="blue-bar">QUIÉNES SOMOS</h2>

    <div class="mem-desc">
      <div class="mem-desc-img">
        <img src="../img/img-6-01.png"  />
      </div>

      <div class="mem-desc-text">
    ...
    <div class="mem-vm">
      ...
      <div class="mem-vm-img">
        <img src="../img/banner-6-01.png">
      </div>
    </div>

   <div class="mem-values">
     <div class="mem-values-img">
       <img src="../img/banner-7-01.png" >
     </div>

    <div class="mem-values-info">
      <div class="mem-values-info-wrapper">
